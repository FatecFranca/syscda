        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-6 ">
                ...
                <div class="custom-control custom-radio">
                    <input @if($family_setting->family_bag) checked="checked" @endif type="radio" id="family_bag_true" name="family_bag" value="1" class="custom-control-input">
                    <label class="custom-control-label" for="family_bag_true">{{ __('default/views.1') }}</label>
                </div>
                <div class="custom-control custom-radio">
                    <input @if(!$family_setting->family_bag) checked="checked" @endif type="radio" id="family_bag_false" name="family_bag" value="0" class="custom-control-input">
            ...
            <div class="form-group col-md-6 ">
                ...
                <div class="custom-control custom-radio">
                    <input @if($family_setting->inss_benefit) checked="checked" @endif type="radio" id="inss_benefit_true" name="inss_benefit" value="1" class="custom-control-input">
                    <label class="custom-control-label" for="inss_benefit_true">{{ __('default/views.1') }}</label>
                </div>
                <div class="custom-control custom-radio">
                    <input @if(!$family_setting->inss_benefit) checked="checked" @endif type="radio" id="inss_benefit_false" name="inss_benefit" value="0" class="custom-control-input">
            ...
            <div class="form-group col-md-6 ">
                ...
                <div class="custom-control custom-radio">
                    <input @if($family_setting->pension) checked="checked" @endif type="radio" id="pension_true" name="pension" value="1" class="custom-control-input">
                    <label class="custom-control-label" for="pension_true">{{ __('default/views.1') }}</label>
                </div>
                <div class="custom-control custom-radio">
                    <input @if(!$family_setting->pension) checked="checked" @endif type="radio" id="pension_false" name="pension" value="0" class="custom-control-input">
