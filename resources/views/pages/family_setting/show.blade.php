...
@section('content')
    @include('components.header', ['urlAction' => route('family_settings.edit', ['id' => $family_setting->id])])
    <div class="form-row">
        <div class="form-group col-md-6">
            <label for="rgi_id">{{ __('rgi/views.rgi') }} * {{ old('rgi_id') }}</label>
            <select disabled class="custom-select" id="rgi_id" name="rgi_id"
                    value="{{ old('rgi_id') }}">
        ...
        <div class="form-group col-md-6">
            ...
            <select disabled class="custom-select" id="type_housing" name="type_housing"
        ...
        <div class="form-group col-md-6 ">
            ...
            <input disabled data-show="true" type="number" class="form-control" id="rent_value" name="rent_value"
                   value="{{ $family_setting->rent_value }}">
        </div>
        <div class="form-group col-md-6 ">
            <span>{{ __('default/views.family_bag') }}</span>
            <div class="custom-control custom-radio">
                <input disabled @if($family_setting->family_bag) checked="checked" @endif type="radio" id="family_bag_true"
                       name="family_bag" value="1" class="custom-control-input">
                <label class="custom-control-label" for="family_bag_true">{{ __('default/views.1') }}</label>
            </div>
            <div class="custom-control custom-radio">
                <input disabled @if(!$family_setting->family_bag) checked="checked" @endif type="radio" id="family_bag_false"
                       name="family_bag" value="0" class="custom-control-input">
        ...
        <div class="form-group col-md-6 ">
            ...
            <input disabled data-show="true" type="number" class="form-control" id="value_bag" name="value_bag"
                   value="{{ old('value_bag', $family_setting->value_bag) }}">
        </div>
        <div class="form-group col-md-6 ">
            <span>{{ __('default/views.inss_benefit') }}</span>
            <div class="custom-control custom-radio">
                <input disabled @if($family_setting->inss_benefit) checked="checked" @endif type="radio" id="inss_benefit_true"
                       name="inss_benefit" value="1" class="custom-control-input">
                <label class="custom-control-label" for="inss_benefit_true">{{ __('default/views.1') }}</label>
            </div>
            <div class="custom-control custom-radio">
                <input disabled @if(!$family_setting->inss_benefit) checked="checked" @endif type="radio" id="inss_benefit_false"
                       name="inss_benefit" value="0" class="custom-control-input">
        ...
        <div class="form-group col-md-6 ">
            ...
            <input disabled data-show="true" type="number" class="form-control" id="value_inss_benefit" name="value_inss_benefit"
                   value="{{ old('value_inss_benefit', $family_setting->value_inss_benefit) }}">
        </div>
        <div class="form-group col-md-6 ">
            <span>{{ __('default/views.pension') }}</span>
            <div class="custom-control custom-radio">
                <input disabled @if($family_setting->pension) checked="checked" @endif type="radio" id="pension_true"
            ...
            <div class="custom-control custom-radio">
                <input disabled @if(!$family_setting->pension) checked="checked" @endif type="radio" id="pension_false"
        ...
        <div class="form-group col-md-6 ">
            ...
            <input disabled data-show="true" type="number" class="form-control" id="pension_amount" name="pension_amount"
                   value="{{ old('pension_amount', $family_setting->pension_amount) }}">
        </div>
        <div class="form-group col-md-6 ">
            <label for="drug_spending">{{ __('default/views.drug_spending') }}</label>
            <input disabled type="number" class="form-control" id="drug_spending" name="drug_spending"
